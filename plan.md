...
**Queue order**: dogfood findings outrank the original listing — ~~WP-217~~ (done), ~~WP-218 slice 1~~ (done, `2a4dd21`), ~~WP-220~~ (done, commit pending review), ~~WP-222 slice 1~~ (done, `18fae43`), ~~WP-223~~ (done, commit pending review), ~~WP-224~~ (done, commit pending review), ~~WP-225~~ (done, dogfood-009, commit pending review), ~~WP-209 slice 1~~ (done, dogfood-010, commit pending review), ~~WP-209 slice 2~~ (done, dogfood-011, commit pending review — both SE-3 footer halves now render), then WP-219's ADR; WP-221 + WP-218 slice 2 (`budget_tokens`) ride with the next architect-reviewed contracts PR; the next dogfoodable 🟢/no-contracts slice is dogfood-012 (WP-209's remaining OTel-metrics work is no longer pure-renderer — see §6). Rationale: `docs/reports/dogfood-002.md` (F-8/F-9/F-10) + `docs/reports/dogfood-003.md` (F-11/F-12/F-13) + `docs/reports/dogfood-004.md` (F-14/F-15/F-16) + `docs/reports/dogfood-005.md` (F-17/F-18) + `docs/reports/dogfood-006.md` (no new F-n — recurrences only) + `docs/reports/dogfood-007.md` (F-19) + `docs/reports/dogfood-008.md` (no new F-n — recurrences only) + `docs/reports/dogfood-009.md` (no new F-n — F-19 closed, recurrences only) + `docs/reports/dogfood-010.md` (no new F-n — recurrences only, F-11 mid-spread 16.1 %) + `docs/reports/dogfood-011.md` (no new F-n — recurrences only, F-11 record-high 34.3 %).
