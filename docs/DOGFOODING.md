...
Progression gate = ⛔ **STALLED** (rung 3→3→3). ℹ️ F-168 (STALLED msg names the retired P2 ladder) · 🟡 F-153/F-154 · 🟡 F-169 (restore not byte-identical for binaries/symlinks) = track-B.
