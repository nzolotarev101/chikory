  ...
  nodes: [
    {
      ...
      acceptanceCriteria: [{ id: "AC-1", description: "The first slice is complete", check: "pnpm exec vitest run" }],
      dependsOn: [],
      budgetUsd: 1,
    },
    {
      ...
      acceptanceCriteria: [{ id: "AC-2", description: "The second slice is complete", check: "pnpm exec tsc --noEmit" }],
      dependsOn: ["N-1"],
      budgetUsd: 1,
    },
  ],
