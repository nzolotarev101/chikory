...
describe("isCompletionMilestone", () => {
  ...
  test("returns true for SUCCESS with an empty diff and claimsComplete=true", () => {
    const record = makeRecord({
      status: "SUCCESS",
      diffRef: { id: "diff", kind: "diff", bytes: 0, summary: "test diff" },
      claimsComplete: true,
  ...
  test("returns true for SUCCESS with an empty diff and claimsComplete=false", () => {
    const record = makeRecord({
      status: "SUCCESS",
      diffRef: { id: "diff", kind: "diff", bytes: 0, summary: "test diff" },
  ...
  test("returns false for FAILED with an empty diff and claimsComplete=true", () => {
    const record = makeRecord({
      status: "FAILED",
      diffRef: { id: "diff", kind: "diff", bytes: 0, summary: "test diff" },
      claimsComplete: true,
  ...
  test("returns false for FAILED with an empty diff and claimsComplete=false", () => {
    const record = makeRecord({
      status: "FAILED",
      diffRef: { id: "diff", kind: "diff", bytes: 0, summary: "test diff" },
      claimsComplete: false,
  ...
  test("returns false for FAILED with a non-empty diff and an explicit completion claim", () => {
    const record = makeRecord({
      status: "FAILED",
      diffRef: { id: "diff", kind: "diff", bytes: 1, summary: "test diff" },
      claimsComplete: true,
