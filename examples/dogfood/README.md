...
| [`dogfood-019.yaml`](dogfood-019.yaml) | WP-221 pure trigger half — `isCompletionMilestone(record)` ORs `claimsComplete` into the WP-217 empty-diff judge trigger (dogfood-003/018 F-11) | not yet run | — |
